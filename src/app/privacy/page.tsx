export default function PoliticaPrivacidade() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 text-gray-700 leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">Política de Privacidade</h1>

      <p className="mb-4">
        A sua privacidade é importante para nós. É política do{" "}
        <strong>Guedes Bampi</strong> respeitar a sua privacidade em relação a
        qualquer informação sua que possamos coletar no site{" "}
        <strong>Guedes Bampi</strong>, e outros sites que possuímos e operamos.
      </p>
      ...
      <p className="mb-4">
        ...
        informação que o <strong>Guedes Bampi</strong> oferece no site e com
      ...
      <ul className="list-disc list-inside space-y-2 mb-8">
        ...
        <li>
          ...
          (softwares) do <strong>Guedes Bampi</strong>, de seus fornecedores ou
      ...
      <p className="text-sm text-gray-500">
        ...
        <strong>1 September 2025 00:39</strong>.
      </p>
    </main>
  );
}
